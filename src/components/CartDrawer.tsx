      ...
      >
        <div className="flex items-center justify-between border-b border-cream/10 bg-ink px-5 py-4">
          ...
          <button
            ...
            className="flex h-9 w-9 items-center justify-center rounded-xl text-cream/80 transition hover:bg-cream/10 hover:text-cream"
          >
            x
          </button>
        </div>
              ...
              {lines.map((line) => (
                ...
                >
                  ...
                  <div className="flex-1">
                    ...
                    <p className="font-body text-xs font-medium text-ink/50">
                      {siteConfig.currency}
                  ...
                  <div className="flex items-center gap-1 rounded-xl bg-cream-dim p-1">
                    ...
                    <span className="w-5 text-center font-body text-xs font-extrabold">
                      {line.qty}
                    </span>
                    <button
                  ...
                  <button
                    ...
                    className="font-bold text-ink/30 transition hover:text-chili"
                  >
                    x
                  </button>
                </div>
        ...
        {lines.length > 0 && (
          <div className="border-t border-ink/10 bg-white px-5 py-4">
            <div className="mb-3 flex flex-col gap-1 font-body text-sm font-semibold text-ink/70">
              ...
              <div className="flex justify-between pt-2 font-display text-2xl leading-none text-ink">
                <span>Total</span>
                <span>
                  {siteConfig.currency}
            ...
            <p className="mt-2 text-center font-body text-[11px] font-medium text-ink/45">
