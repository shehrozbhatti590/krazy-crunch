...
export default function LocationSection() {
  return (
    <section id="location" className="mx-auto max-w-6xl px-5 py-16 md:px-8 md:py-24">
      <div className="grid grid-cols-1 gap-10 overflow-hidden rounded-2xl bg-white p-8 shadow-xl shadow-ink/8 ring-1 ring-ink/8 md:grid-cols-2 md:p-14">
        <div>
          ...
          <a
            ...
            className="krazy-bite mt-6 inline-flex items-center gap-2 rounded-xl bg-chili px-6 py-3.5 font-body text-sm font-extrabold uppercase tracking-wider text-cream shadow-lg shadow-chili/25 transition hover:bg-chili-dark active:scale-95"
          >
            <span aria-hidden>{"\u{1F4AC}"}</span> {siteConfig.phoneDisplay}
          </a>
        </div>

        <div className="rounded-xl bg-cream p-5 ring-1 ring-ink/8">
          <span className="font-body text-xs font-extrabold uppercase tracking-[0.2em] text-chili">
            Hours
          </span>
